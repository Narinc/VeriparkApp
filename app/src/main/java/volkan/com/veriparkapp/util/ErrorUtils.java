...
/**
 * Created by volkannarinc on 03/07/17 17:41.
 */
...
public class ErrorUtils {
    ...
    public static Snackbar showSnackbar(View view, @StringRes int errorMessage, Throwable t,
        ...
        if (noConnection || timeout) {
            ...
            return showSnackbar(view, errorMessage, VeriparkApp.getInstance().getString(R.string.no_internet_connection), actionLabel, clickListener);
        } else {
    ...
    public static Snackbar showSnackbar(View view, @StringRes int errorMessage, String error,
                                        @StringRes int actionLabel, View.OnClickListener clickListener) {
        String errorMessageString = VeriparkApp.getInstance().getString(errorMessage);
